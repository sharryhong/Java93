...
=> 요청 예) http://localhost:8889/student/add.do?name=홍길동새거&tel=1111&email=hongnew@test.com&password=1111&working=Y&schoolName=비트대학교
=> 출력 예) 입력 성공입니다!
  입력되었는지 여부는 test04_1.js를 통해 확인. 혹은 db를 통해 확인
*/
...
server.listen(8889) // 마이크로 서비스를 위해 바꾸자
console.log("서버 실행 중..")
