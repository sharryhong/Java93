...
if ((value % 2) == 0)
  console.log("짝수");
  console.log("입니다."); // 파이썬은 블록이 아니라 들여쓰기로 구분하므로 이게 먹음. 하지만 거의 대부분의 언어는 들여쓰기 상관없다.
console.log('-------------------------------');
...
if ((value % 2) == 0); // <-- 세미콜론을 사용하는 순간 한 문장이 끝났음을 표시하는 것이다.
  console.log("짝수입니다.");
value = 11;
if ((value % 2) == 0); // 세미콜론을 사용하는 순간 한 문장이 끝났음을 표시하는 것.
  console.log("짝수입니다."); // if문에 속하지 않게된다. 그래서 실행된다.
console.log('-------------------------------');
