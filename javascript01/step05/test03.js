...
// Boolean인 경우
v1 = true // 메모리 내부적으로는 true를 의미하는 1이 들어가있다.
v2 = v1
v1 = false // 메모리 내부적으로는 false를 의미하는 0이 들어간다.
console.log(v1, v2)

// 문자열인 경우 : 얘도 주소!! 이뮤터블 객체(immutable object)라고해서 값을 바꿀 수없다. 값을 주고받는 것처럼 동작하는것뿐이다.
// 8byte이내일때는 직접 값을 저장하지만, 보통 문자열은 8byte가 넘어갈 수 있고 값이 바뀔 수 있기 때문에 주소를 저장한다.
// 문자열은 배열이나 객체와 다르게 값을 변경할 수 없다! = immutable object
v1 = "홍길동"
v2 = v1
v1 = '임꺽정'
console.log(v1, v2)
...
console.log(Number.MAX_SAFE_INTEGER) // 8byte. 약 9천조?
