...
// 에러. x는 존재하지 않는 변수이기 때문에 비교 연산자를 사용할 수는 없다.
...
// 암시적 형변환. undefined -> false
if (v1) console.log("v1가 false이면 이거 실행안되요.");
