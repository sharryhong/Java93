...
select la.lano, l.titl
  from lect_appy la inner join lect l on la.lno = l.lno; -- 왼쪽 오른쪽 바뀌어도 되네

-- select la.lano, l.titl
--   from lect l inner join lect_appy la on la.lno = l.lno;
...
-- select la.lano, l.titl, cr.name
--   from lect_appy la inner join lect l on la.lno = l.lno left outer join croom cr on l.crmno = cr.crmno;
-- select la.lano, l.titl, cr.name
--   from lect l inner join lect_appy la on la.lno = l.lno left outer join croom cr on cr.crmno = l.crmno;
