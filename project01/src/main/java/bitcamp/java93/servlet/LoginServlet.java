...
//        res.setHeader("Refresh", "5;url=../member/list");
        ...
        this.getServletContext().setAttribute("id_" + sessionId, member); // 숫자+문자=>문자로 바뀐다.
        
        out.println("<h1>로그인 성공</h1>");
        out.println("<p>다음 번호를 잘 보관해 두었다가 서버에 요청할 때마다 </p>");
        out.println("<p>sessionId라는 이름으로 파라미터를 추가해서 보내기 바랍니다.</p>");
        out.printf("<p>%d</p>\n", sessionId);
