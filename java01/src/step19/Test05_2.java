/* 멀티 태스킹 : Critical Section(Critical Region) 2
 * => 크리티컬 섹션을 실행할 때 한번에 한스레드만이 진입하게 만드는 방법
 */
package step19;
...
public class Test05_2 {
  ...
  static class Account {
    ...
    // synchronized만 붙이면 된다! 와우!
    synchronized public long withdraw(long money) { // 돈 인출
